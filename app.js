...
app.use(hpp({ //meken wenne request ekedi attaker kenek ekam flid name ekam reqest ekedi ekaprkat wada use krla query eka ghn eka nwttna eka.ekawage filed names ain krla dnw
    whitelist: [ //WHITE LIST EKA KIYNNE EHEM DUPLICATE WLA THYENNA INU LIST EKA ARRAY EKKIN DENA EKA
